<?php
    ...
    // // echo $sql;
    // // $stmt = $conn->query($sql);
    // $stmt = $conn->prepare($sql);  //query အနေနဲ့အလုပ်လုပ်မှာ
    // $stmt->execute(); //တကယ် data တွေကိုထုတ်မှာ
    // $posts = $stmt->fetchAll(); // data တွေကို array အနေနဲ့ထွက်လာအောင်လုပ်တာ
        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">Welcome to Hsu Blog!</h1>
